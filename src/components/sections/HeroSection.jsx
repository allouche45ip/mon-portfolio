...
// import { useState, useEffect } from "react"
// import { Github, Linkedin, Mail, Phone, Download, ShieldCheck } from "lucide-react"
// import imagess from "../../assets/images/computer-2788918_1280.jpg";
...
//   // 🔥 Updated roles: networking / security / embedded first, web dev kept as past experience
//   const roles = [
//     "Network Engineer",
//     "Embedded Systems Engineer",
//      "Cybersecurity & Systems Security",
//     "Web Developer (past experience)",
//   ]
...
//   return (
//     <section id="home" className="pt-16 scroll-mt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
//       {/* Background Effects — switched to a darker, more technical/security feel */}
...
//       {/* subtle "circuit/network" grid overlay for a technical feel */}
//       <div
...
//                 Allouche Mohamed
//               </h1>
//               <div className="text-xl md:text-2xl text-gray-300 mb-6 min-h-[2.5rem]">
//                 And I'm a{" "}
//                 <span
//                   className={`
//                   bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent font-semibold
//                   transition-all duration-300 inline-block
//                   ${isVisible ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-2"}
//                 `}
//                 >
...
//               {/* small badge row — quick credibility markers */}
//               <div className="flex flex-wrap justify-center lg:justify-start gap-2 mb-4">
//                 <span className="px-3 py-1 rounded-full text-xs font-medium bg-cyan-400/10 text-cyan-300 border border-cyan-400/30">
//                   Master — Networks & Embedded Systems
//                 </span>
...
//                   <ShieldCheck className="w-3 h-3" /> Network Security
//                 </span>
//                 <span className="px-3 py-1 rounded-full text-xs font-medium bg-purple-400/10 text-purple-300 border border-purple-400/30">
...
//             <p className="text-gray-400 text-lg mb-8 max-w-2xl">
//   IT engineering student specializing in{" "}
//   <span className="text-cyan-400">network engineering</span>,{" "}
//   <span className="text-cyan-400">embedded systems</span>, and{" "}
//   <span className="text-cyan-400">cybersecurity</span>. I design and analyze secure network
//   infrastructures, develop embedded and IoT systems close to hardware, and leverage my
//   experience in web development to build complete end-to-end technical solutions.
// </p>
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="w-12 h-12 rounded-full bg-gradient-to-r from-cyan-400 to-emerald-400 flex items-center justify-center hover:scale-110 transition-transform duration-300"
//               >
...
//               <button
//                 className="bg-gradient-to-r from-cyan-400 to-emerald-400 text-gray-900 px-8 py-3 rounded-full font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
...
//               {/* New: CV download — recruiters look for this immediately */}
//               <a
...
//           <div className="lg:w-1/2 flex justify-center">
//             <div className="relative group">
//               {/* Animated Background Rings — recolored to cyan/emerald (network/security tone) */}
//               <div className="absolute inset-0 rounded-full">
//                 <div className="absolute inset-0 rounded-full bg-gradient-to-r from-cyan-400 via-emerald-400 to-cyan-500 animate-spin-slow opacity-75"></div>
//                 <div className="absolute inset-2 rounded-full bg-gradient-to-r from-emerald-400 via-cyan-500 to-cyan-400 animate-spin-reverse opacity-50"></div>
//                 <div className="absolute inset-4 rounded-full bg-gradient-to-r from-cyan-400 to-emerald-400 animate-pulse"></div>
//               </div>

//               {/* Main Image Container */}
//               <div
//                 className="relative w-80 h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-r from-cyan-400 via-emerald-400 to-cyan-500 p-1 transform transition-all duration-500 group-hover:scale-105"
//                 style={{
//                   transform: `translate(${mousePosition.x * 0.02}px, ${mousePosition.y * 0.02}px) scale(${1 + (mousePosition.x + mousePosition.y) * 0.0001})`,
//                 }}
//               >
...
//               {/* Floating Particles */}
//               <div className="absolute -top-8 -right-8 w-4 h-4 bg-cyan-400 rounded-full animate-float opacity-80"></div>
//               <div className="absolute -top-12 right-12 w-2 h-2 bg-emerald-400 rounded-full animate-float-delay-1 opacity-60"></div>
//               <div className="absolute top-8 -right-12 w-3 h-3 bg-cyan-500 rounded-full animate-float-delay-2 opacity-70"></div>

//               <div className="absolute -bottom-8 -left-8 w-4 h-4 bg-emerald-400 rounded-full animate-float-delay-3 opacity-80"></div>
//               <div className="absolute -bottom-12 left-12 w-2 h-2 bg-cyan-400 rounded-full animate-float opacity-60"></div>
//               <div className="absolute bottom-8 -left-12 w-3 h-3 bg-cyan-500 rounded-full animate-float-delay-1 opacity-70"></div>

//               {/* Orbiting Elements */}
//               <div className="absolute inset-0 animate-orbit">
//                 <div className="absolute -top-6 left-1/2 w-3 h-3 bg-gradient-to-r from-cyan-400 to-emerald-400 rounded-full transform -translate-x-1/2"></div>
//               </div>
//               <div className="absolute inset-0 animate-orbit-reverse">
//                 <div className="absolute -bottom-6 left-1/2 w-2 h-2 bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-full transform -translate-x-1/2"></div>
//               </div>

//               {/* Pulsing Rings */}
//               <div className="absolute inset-0 rounded-full border-2 border-cyan-400/30 animate-ping"></div>
//               <div className="absolute inset-8 rounded-full border border-emerald-400/20 animate-ping animation-delay-1000"></div>
//             </div>
//           </div>
//         </div>
//       </div>
...
// 🔁 Replace these 4 imports with your own image files (one per role, same order as `roles` below)
import networkImg from "../../assets/images/albert-stoynov-dyUp7WPu5q4-unsplash.jpg"
import embeddedImg from "../../assets/images/computer-2788918_1280.jpg"
import securityImg from "../../assets/images/pixelcreatures-security-265130.jpg"
import imagess from "../../assets/images/computer-2788918_1280.jpg" // your personal photo — kept for "Web Developer"
...
const HeroSection = () => {
  ...
  // Roles + matching image — SAME index in both arrays
  const roles = [
    "Network Engineer",
    "Embedded Systems Engineer",
    "Cybersecurity & Systems Security",
  ...
  const roleImages = [
    networkImg,   // index 0 → Network Engineer
    embeddedImg,  // index 1 → Embedded Systems Engineer
    securityImg,  // index 2 → Cybersecurity & Systems Security
    imagess,       // index 3 → Web Developer (your photo)
  ]
    ...
    <section id="home" className="pt-16 scroll-mt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          {/* Enhanced Profile Image — now swaps per role */}
          <div className="lg:w-1/2 flex justify-center">
            <div className="relative group">
              {/* Animated Background Rings */}
              <div className="absolute inset-0 rounded-full">
              ...
              >
                <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center overflow-hidden relative">
                  {/* 🔁 image source now follows currentRole, fades in sync with the title via isVisible */}
                  <img
                    src={roleImages[currentRole]}
                    alt={roles[currentRole]}
                    className={`w-full h-full object-cover rounded-full transition-all duration-500 group-hover:scale-110 group-hover:brightness-110 ${
